  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Insights and trends from your product data</p>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{formatPrice(analytics.totalValue)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{analytics.averageRating.toFixed(2)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{formatPrice(analytics.averagePrice)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{analytics.outOfStockProducts}</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600">High Stock Products</p>
                  <p className="text-2xl font-bold text-gray-900">{analytics.highStockProducts}</p>
